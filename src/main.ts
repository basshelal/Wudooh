...
class DefaultPlugin extends AbstractWudoohPlugin implements WudoohPlugin {
    ...
    public static instance: DefaultPlugin = new DefaultPlugin()
}
...
async function loopOverNodes(nodes: Array<Node>, plugins: Array<WudoohPlugin>): Promise<void> {
    // TODO: Reuse for mutation observer and main function
